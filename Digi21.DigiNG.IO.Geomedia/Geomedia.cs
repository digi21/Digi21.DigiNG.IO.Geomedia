...
namespace Digi21.DigiNG.IO.Geomedia
{
    public class Geomedia : IDrawingFile, IDisposable
    {
        ...
        public Geomedia(string path, [MarshalAs(UnmanagedType.U1)] bool readOnly) { throw null; }
        public Geomedia(string path, DigiTab.DigiTab digiTab, DelegateGetWkt GetWkt) { throw null; }
        public Geomedia(string path, DigiTab.DigiTab digiTab, [MarshalAs(UnmanagedType.U1)] bool readOnly) { throw null; }
        public Geomedia(string path, DelegateGetWkt GetWkt, [MarshalAs(UnmanagedType.U1)] bool readOnly) { throw null; }
        public Geomedia(string path, DigiTab.DigiTab digiTab, DelegateGetWkt GetWkt, [MarshalAs(UnmanagedType.U1)] bool readOnly) { throw null; }
